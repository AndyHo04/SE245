...
namespace Week1_Samplel {
    class Program {
        static void Main (string[] args) {
            ...
            Int32 intNum1 = 0, intNum2 = 0, intResult = 0;//declare integer variables(the first number, the second number, and the result)
            Double dblResult;//declare double variable(the result)
